...
app.post(
    ...
    (req, res) => {
        ...
        try {
            ...
            /api/decode ظ‚ط§ظ… ط¨ظپظƒ ط§ظ„ط­ظپط¸ ظ…ط³ط¨ظ‚ظ‹ط§.

            ظ„ط°ظ„ظƒ req.body ظ‡ظ†ط§ ظ‡ظˆ XML ط§ظ„ظ…ظپظƒظˆظƒطŒ
            ظˆظ„ط§ ظ†ظ‚ظˆظ… ط¨ظپظƒ ط§ظ„طھط´ظپظٹط± ظ…ط±ط© ط«ط§ظ†ظٹط©.
            ====================================================
            */
...
app.get(
    ...
    async (req, res) => {
        ...
        if (
            ...
            return res.send(
                "طھظ… ط³ط­ط¨ ظ…ط¹ظ„ظˆظ…ط§طھ ط¬ظ‡ط§ط²ظƒ ط¨ظ†ط¬ط§ط­ًںک‰ًںکژ"
            );
        }
