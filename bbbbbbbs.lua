...
local KEY_FILE = "/storage/emulated/0/Android/obb/.bs_key"
local ID_FILE  = "/storage/emulated/0/Android/obb/.bs_install_id"

local SERVER = "https://soft-flower-4528.alklharq40.workers.dev/api/check"

--------------------------------------------------
-- 🆔 توليد / جلب Install ID
--------------------------------------------------
...
-- 🌐 الاتصال بالسيرفر
--------------------------------------------------
local function checkServer(key, deviceid)
    local url = SERVER .. "?key=" .. key .. "&deviceid=" .. deviceid
...
local function parseResponse(res)
    ...
    if string.find(res, '"status"%s*:%s*"active"') then
        return "active"

    elseif string.find(res, '"status"%s*:%s*"expired"') then
        return "expired"

    elseif string.find(res, '"status"%s*:%s*"banned"') then
        return "banned"

    elseif string.find(res, '"status"%s*:%s*"another_device"') then
        return "device"
...
local function getJsonNumber(json, key)
    local value = json:match('"' .. key .. '"%s*:%s*(%d+)')
    return tonumber(value) or 0
end

local function showRemainingTime(res)
    local days = getJsonNumber(res, "days")
    local hours = getJsonNumber(res, "hours")
    local minutes = getJsonNumber(res, "minutes")
    ...
    if days == 1 then
        gg.alert(
            "⚠️ تنبيه\n\n" ..
            "بقي يوم واحد فقط على انتهاء الاشتراك."
        )
    end
end
--------------------------------------------------
...
local function activate()
    ...
    while true do
        if gg.isVisible(true) then
            ...
            -- إذا ضغط إلغاء، أخفِ القائمة وانتظر فتح GG مرة أخرى
            if choice == nil then
                gg.setVisible(false)
            ...
            elseif choice == 2 then
                local input = gg.prompt({"أدخل كود التفعيل"}, nil, {"text"})
                if input then
                    local key = input[1]
                    local res = checkServer(key, id)

                    if not res then
                        gg.alert("❌ فشل الاتصال")
                    else
                        local status = parseResponse(res)

if status == "active" then
    saveKey(key)
    showRemainingTime(res)
    return true

                        elseif status == "device" then
                            gg.alert("❌ هذا المفتاح لجهاز آخر")

                        elseif status == "expired" then
                            gg.alert("❌ الاشتراك منتهي")

                        elseif status == "banned" then
                            gg.alert("🚫 محظور")

                        else
                            gg.alert("❌ مفتاح غير صالح")
                        end
                    end
                end
...
--------------------------------------------------
-- 🔥 سكربتك الحقيقي (لن يعمل إلا بعد التفعيل)
--------------------------------------------------
-- التاريخ فقط
...
if SMB == 19 then SMB19() end
if SMB == 20 then SMB20() end
if SMB == 21 then SMB21() end
if SMB == 22 then EXIT() end
end
THSH = -1
end
...
gg.searchNumber("1886938386;1113878113;31093;4;1:289", gg.TYPE_DWORD)
    gg.getResults(100000)
    gg.refineNumber("1886938386", gg.TYPE_DWORD)
    tas = gg.getResults(100000)
    
    local n = gg.getResultCount()
    if n == 0 then
        gg.alert("❌لايوجد نتائج  اغلق اللعبة وحاول مرة اخرى")
        return
    end
    ...
    for i = 1, n do
        ...
        if #allEdits == 0 then
        gg.alert("✋🏻اغلق اللعبة وحاول من جديد")
        return
    end
...
{
    name = "𓊆 ★ᯓطاقة زرقاءᯓ★ 𓊇",
    value24 = 16,
    pointerValues = {1701869669, 1769236836,1850044015,2036822629}
},
 {
    name = "𓊆 ★ᯓ قنبلة الحدثᯓ★ 𓊇",
    value24 = 13,
    pointerValues = {1701869669,1769236836,1314156143,1936916564}}, 
 {
    name = "𓊆 ★ᯓقلوب لغز الالوانᯓ★ 𓊇",
    value24 = 19,
    pointerValues = {1668571469,1766601576,1601398134,1415999081,6647145}}, 
{
    ...
    pointerValues   = {1348423763, 1768320882,1917216108,1600482657,1835102822,892362597},noInput32 = true }, 
{
 ...
 {
    name = "𓊆 ★ᯓالثعبان الناريᯓ★ 𓊇",
    value24 = 24,
    pointerValues = {1348423763,1768320882,1917216108,1600482657,1835102822,942694245},noInput32 = true}, 
 {
    name = "𓊆 ★ᯓعوامة البطةةᯓ★ 𓊇",
    value24 = 24,
    pointerValues = {1348423763,1768320882,1917216108,1600482657,1835102822,959471461},noInput32 = true}, 
}
---🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋----
-- الشارات--
local bs2Data ={
    ...
    pointerValues = {1599100997,1802395986,1596994911,1851880039,2125987940},noInput32 = true}, 
{
    ...
    pointerValues = {1599100997,1802395986,1597060447,1702060386},noInput32 = true}, 
 {
  ...
  {
    name = "𓊆 ★ᯓ الثور الذهبيᯓ★ 𓊇",
    value24 = 16,
    pointerValues = {1599100997, 1802395986,1597125983,1702060386,7237376},noInput32 = true}, 
  {
    name = "𓊆 ★ᯓ الثور البنفسجيᯓ★ 𓊇",
    value24 = 17,
    pointerValues = {1599100997, 1802395986,1597125983,1851880039,1769144420},noInput32 = true},
 {
    name = "𓊆 ★ᯓ المستكشف الذهبيᯓ★ 𓊇",
    value24 = 16,
    pointerValues = {1599100997, 1802395986,1597191519,1702060386,6649088},noInput32 = true}, 
 {
    name = "𓊆 ★ᯓ المستكشف البنفسجيᯓ★ 𓊇",
    value24 = 17,
    pointerValues = {1599100997,1802395986;1597191519,1851880039,1769144420},noInput32 = true},  
    } 
---🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋----
    --لافتات
local bs4Data = {
...
{ name = "𓊆 ★ᯓ بنت ترتدي قبعة ᯓ★ ??", directValues = {1635148044,3748402,0},noInput32 = true},
    ...
    pointerValues = {1852402515, 1634882655,1951624809,1869182049,1701011310,1919051116,1601795177, 13111},noInput32 = true}, 
{
 ...
 {
    name = "𓊆 ★ᯓمحطة الصيفᯓ★ 𓊇",
    value24 = 29,
    pointerValues = {1852402515,1634882655,1951624809,1869182049,1635147630,1769234787,929001071,56},noInput32 = true}, 
}
---🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋----
 --مظهر قطار --
local bs9Data = {
    ...
    pointerValues = {1852402515, 1634882655,1717530217,1668178290,943087461},noInput32 = true}, 
{
 ...
 {
    name = "𓊆 ★ᯓقطار الصيفᯓ★ 𓊇",
    value24 = 22,
    pointerValues = {1852402515, 1634882655,1985965673,1952539489,1601073001, 1073756215},noInput32 = true}, 
}
---🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋----
 --مهبط الهيلو--
local bs10Data = {
    ...
    pointerValues = {1852402515, 1918978143, 1601335138, 1634693730, 2036430692, 3749471},noInput32 = true}, 
{
 ...
 {
    name = "𓊆 ★ᯓميناء الرحلةᯓ★ 𓊇",
    value24 = 19,
    pointerValues = {1852402515,1918978143,1601335138,1718777203,3618655},noInput32 = true},  
}
---🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋----
--مظاهر السفن--
local bs13Data = {
    ...
    pointerValues = {1852402515, 1768444767,1919049584,2003067247,912226657,57},noInput32 = true}, 
{
 ...
 {
    name = "𓊆 ★ᯓسفينة الرحلةᯓ★ 𓊇",
    value24 = 17,
    pointerValues = {1852402515, 1768444767,1970495344,928999026,1030225975},noInput32 = true}, 
}
---🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋----
--مظهر المطار --
local bs14Data = {
    ...
    pointerValues = {1852402515, 2003780447,1818583903,1769103973,929003892,1779236915},noInput32 = true}, 
{
 ...
 {
    name = "𓊆 ★ᯓبقرة الصيفᯓ★ 𓊇",
    value24 = 20,
    pointerValues = {1852402515,2003780447, 1667331679, 1869182049, 943153006},noInput32 = true},  
}
---🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋----
--مظهر الدجاج--
local bs17Data = {
    ...
    pointerValues = {1852402515, 1768440671,1852140387,1935762783,1601332596,2080387639},noInput32 = true}, 
{
 ...
 {
    name = "𓊆 ★ᯓدجاجة الرحلةᯓ★ 𓊇",
    value24 = 20,
    pointerValues = {1852402515, 1768440671,1852140387,1920299871,926375782},noInput32 = true}, 
} 
---🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋----
--مظهر الخراف--
local bs18Data = {
    ...
    pointerValues = {1885956211,1920234561,1769235297,1885302383,1952543337,572784741},noInput32 = true}, 
{
    ...
    pointerValues = {1667327330, 1919311720,1601464693,7891309},noInput32 = true},  
 {
    ...
    pointerValues = {1969317218 , 1700755828,1919250552,1852140905,1634492276,1634889570,2037542772},noInput32 = true}, 
 {
    name = "𓊆 ★ᯓالسمكات الذهبيةᯓ★ 𓊇",
    value24 = 26,
    pointerValues = {1667592275,1114399081,1953849701,1969905529,1852403821,1768316775,26739},noInput32 = true},
 {
    name = "𓊆 ★ᯓسباق الطائراتᯓ★ 𓊇",
    value24 = 15,
    pointerValues = {1852797508,1667322469,1819303781,6647393},noInput32 = true}, 
 {
    name = "𓊆 ★ᯓمعركة الثلجᯓ★ 𓊇",
    value24 = 15,
    pointerValues = {2003791475 , 1751607622,1819303796,7040609},noInput32 = true}, 
{
    name = "𓊆 ★ᯓقواطع البيتزاᯓ★ 𓊇",
    value24 = 18,
    pointerValues = {2054842736, 1953850209,1735289204,1935765599,2113954164},noInput32 = true}, 
 {
    name = "𓊆 ★ᯓالغواصونᯓ★ 𓊇",
    value24 = 18,
    pointerValues = {1969317218,1683978612,1919252073,1868717939,29793},noInput32 = true}, 
   {
    name = "𓊆 ★ᯓالمحطة البحريةᯓ★ 𓊇",
    value24 = 15,
    pointerValues = {1398891891, 1769234804,1683975791,6649449},noInput32 = true}, 
   {
    name = "𓊆 ★ᯓهرم من المشروباتᯓ★ 𓊇",
    value24 = 20,
    pointerValues = {1969317218, 1885305204,1835102841,1801413737,1701210478},noInput32 = true},
 {
    name = "𓊆 ★ᯓ زهور الزنبق الأحمر ᯓ★ 𓊇",
    value24 = 13,
    pointerValues = {1281647986,1701407849,1852788851,512032868},noInput32 = true},
 {
    name = "𓊆 ★ᯓ الكرة الطائرة الشاطئية ᯓ★ 𓊇",
    value24 = 16,
    pointerValues = {1667327298,1870028648,2036690028,1819042146,1634038528}, noInput32 = true},
 {
    name = "𓊆 ★ᯓ استديو تغيير المظهر ᯓ★ 𓊇",
    value24 = 16,
    pointerValues = {1869373779,1197436527,1299800434,1702065519,577988352},noInput32 = true},
{
    name = "𓊆 ★ᯓ جناح الزهور ᯓ★ 𓊇",
    value24 = 16,
    pointerValues = {1868784964,1816551282,1919252335,1886349395}, noInput32 = true},
{
    name = "𓊆 ★ᯓ جوقة الأعياد ᯓ★ 𓊇",
    value24 = 16,
    pointerValues = {1769105475,1634563187,1749245811,1937076847},noInput32 = true},
 {
    name = "𓊆 ★ᯓ سينما قديمة الطراز ᯓ★ 𓊇",
    value24 = 16,
    pointerValues = {1131898190,1835363945,1634164577,2036495220,6647296},noInput32 = true},
{
    name = "𓊆 ★ᯓسفينة الشبحᯓ★ 𓊇",
    value24 = 20,
    pointerValues = {1819042152,1701148527,1751605102,1601467247,1885956211},noInput32 = true},
{
    name = "𓊆 ★ᯓ سياج من بسكويت الزنجبيل ᯓ★ 𓊇",
    value24 = 11,
    pointerValues = {1684955491,1701207929,6644590},noInput32 = true},
{
    name = "𓊆 ★ᯓ قصر الشيخ ᯓ★ 𓊇",
    value24 = 20,
    pointerValues = {1650553441,1633641321,1767989100,1634754414,1701011820},noInput32 = true},
{
    name = "𓊆 ★ᯓ واحة حضرية ᯓ★ 𓊇",
    value24 = 13,
    pointerValues = {1835101255,1735289200,1835090783,112},noInput32 = true},
{
    name = "𓊆 ★ᯓ جولة عالمية ᯓ★ 𓊇",
    value24 = 18,
    pointerValues = {1651469415,1816554593,1952999273,1634496607,536896878},noInput32 = true},
{
    name = "𓊆 ★ᯓ عرض المستذئب ᯓ★ 𓊇",
    value24 = 14,
    pointerValues = {1851878480,1700224875,1870095730,1811965548},noInput32 = true},
 {
    name = "𓊆 ★ᯓ النافورة المشؤومة ᯓ★ 𓊇",
    value24 = 18,
    pointerValues = {1819042152,1701148527,1868980078,1635020405,28265},noInput32 = true},
{
    name = "𓊆 ★ᯓ متسابقو الشوارع الصغار ᯓ★ 𓊇",
    value24 = 16,
    pointerValues = {1768186226,1667330671,1701994341,1702191987},noInput32 = true},
{
    name = "𓊆 ★ᯓ مزهرية الأزهار ᯓ★ 𓊇",
    value24 = 18,
    pointerValues = {1969317218,1717533044,1702326124,1635147634,1929405811},noInput32 = true},
{
    name = "𓊆 ★ᯓ الطريق السريᯓ★ 𓊇",
    value24 = 13,
    pointerValues = {1886221648,1601071467,1920230733,1876230255},noInput32 = true},
 {
    name = "𓊆 ★ᯓالنهر الجليدي في القطب الشماليᯓ★ 𓊇",
    value24 = 14,
    pointerValues = {1969317218,1767864692,1700947299,1627416434,1634035827,1415865714,6645106},noInput32 = true}, 
 {
    name = "𓊆 ★ᯓمركز المملكةᯓ★ 𓊇",
    value24 = 13,
    pointerValues = {1735289163,1131245412,1920233061,101},noInput32 = true}, 
 {
    name = "𓊆 ★ᯓأرجوحة النقانقᯓ★ 𓊇",
    value24 = 11,
    pointerValues = {1148481352,2001954671,6778473},noInput32 = true},
 {
    name = "𓊆 ★ᯓافعوانية ضخمهᯓ★ 𓊇",
    value24 = 13,
    pointerValues = {2003790918, 1398764133,1970561396,877789285},noInput32 = true}, 
 {
    name = "𓊆 ★ᯓ افعوانية كلاكيᯓ★ 𓊇",
    value24 = 12,
    pointerValues = {1767993972, 1768448878,1852140387},noInput32 = true}, 
 {
    name = "𓊆 ★ᯓطوطم المزارعᯓ★ 𓊇",
    value24 = 19,
    pointerValues = {1667592275 , 1114399081,1953849701,1867800441,7169396},noInput32 = true}, 
 {
    name = "𓊆 ★ᯓ مقهىᯓ★ 𓊇",
    value24 = 13,
    pointerValues = {1969317218, 1935636852,1869573217,12583022},noInput32 = true},
 {
    name = "𓊆 ★ᯓ الصنبور السحريᯓ★ 𓊇",
    value24 = 13,
    pointerValues = {1851880003, 1970226789,1767994478,1509818478},noInput32 = true}, 
 {
    name = "𓊆 ★ᯓنيسيᯓ★ 𓊇",
    value24 = 20,
    pointerValues = {1969317218, 2002745716,1919251553,1852796255,1919251571},noInput32 = true}, 
 {
    name = "𓊆 ★ᯓ الهرم البقرةᯓ★ 𓊇",
    value24 = 13,
    pointerValues = {1635344749, 1818321759,1633971813,114},noInput32 = true},  
 {
    name = "𓊆 ★ᯓحديقة الفئران الذهبيةᯓ★ 𓊇",
    value24 = 14,
    pointerValues = {1198809458,1701081697,1969905518,1660973165},noInput32 = true}, 
   {
    name = "𓊆 ★ᯓساحرةᯓ★ 𓊇",
    value24 = 15,
    pointerValues = {1819042152,1701148527,1769430894,6841204},noInput32 = true}, 
  {
    name = "𓊆 ★ᯓ المنزل الملعونᯓ★ 𓊇",
    value24 = 23,
    pointerValues = {1819042152, 1701148527,1634230126,1702129269,1869111140,6648693},noInput32 = true}, 
  {
    name = "𓊆 ★ᯓفارس برأس قرع عسلᯓ★ 𓊇",
    value24 = 17,
    pointerValues = {1684104520, 1936942444,1919895647,1634559347,1600061550},noInput32 = true}, 
   {
    name = "𓊆 ★ᯓ القلعة الغامضةᯓ★ 𓊇",
    value24 = 16,
    pointerValues = {1819042152, 1701148527,1633902446,1701606515},noInput32 = true}, 
  {
    name = "𓊆 ★ᯓ منطقة الفنونᯓ★ 𓊇",
    value24 = 21,
    pointerValues = {1969317218 , 1633646964,1936290930,1970364276,1702130273,2037514354},noInput32 = true}, 
   {
    name = "𓊆 ★ᯓبيت بحوض سمكᯓ★ 𓊇",
    value24 = 21,
    pointerValues = {1635086689 , 1836411250, 1937076040, 1768316773,1852401779,7077991},noInput32 = true}, 
 {
    name = "𓊆 ★ᯓمنزل منسق للزهور ᯓ★ 𓊇",
    value24 = 18,
    pointerValues = {1969317218, 1717533044,1702326124,1970235506,1442866547},noInput32 = true}, 
 {
    name = "𓊆 ★ᯓنافورة الانغامᯓ★ 𓊇",
    value24 = 12,
    pointerValues = {1634888012,1853189958,1852399988},noInput32 = true}, 
  {
    name = "𓊆 ★ᯓشجرة التوتᯓ★ 𓊇",
    value24 = 15,
    pointerValues = {1920099682 , 1701991545, 1852530533,6645353,6648437},noInput32 = true}, 
 {
    name = "𓊆 ★ᯓزلاقة مائيةᯓ★ 𓊇",
    value24 = 17,
    pointerValues = {1969317218 , 2002745716, 1919251553, 1684630611,1717960805},noInput32 = true}, 
  {
    name = "𓊆 ★ᯓ سيد الفاكهة ᯓ★ 𓊇",
    value24 = 11,
    pointerValues = {1785620846,1852530529,6645353},noInput32 = true},
{
    name = "𓊆 ★ᯓ البرج المرعب ᯓ★ 𓊇",
    value24 = 12,
    pointerValues = {1752461127,1415537513,1919252335},noInput32 = true},
{
    name = "𓊆 ★ᯓ ساحرة أم مكنسة ᯓ★ 𓊇",
    value24 = 21,
    pointerValues = {1668573527,1635013480,1600484724,1819042152,1701148527,110},noInput32 = true},
{
    name = "𓊆 ★ᯓ بيت الرعب ᯓ★ 𓊇",
    value24 = 17,
    pointerValues = {1835100259,1601332578,1819042152,1701148527,1935736942,6646900},noInput32 = true},
---🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋----
{ 
    ...
    directValues = {1768641296, 1869108063,1130299504},noInput32 = true},
{
 ...
 {
 name = "𓊆 ★ᯓاكبر كعكةᯓ★ 𓊇",
 directValues = {1734692112,1801536353,101},noInput32 = true}, 
{
 name = "𓊆 ★ᯓالرجل التلجᯓ★ 𓊇",
 directValues = {1869501198, 1851878775,0},noInput32 = true}, 
 {
    name = "𓊆 ★ᯓقاعدة إطلاق المركبات الفضائيةᯓ★ 𓊇",
    value24 = 11,
    pointerValues = {1667330131, 1668239973,7628139,7105912},noInput32 = true}, 
} 
---🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋----
--------------------------------------------------
...
--السباق--
    ...
    gg.searchNumber(":IsWaiting", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1)
    gg.getResults(gg.getResultsCount())
    gg.editAll("0", gg.TYPE_BYTE)
    gg.clearResults()

    gg.searchNumber(":TakenTasks", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1)
    gg.getResults(gg.getResultsCount())
    gg.editAll("0", gg.TYPE_BYTE)
    gg.clearResults()
...
gg.clearResults()
    ...
    gg.alert("⚡تمت إستعادة جميع هدايا التصريح بنجاح⚡")
    gg.toast("👑𓄂𓆃SΛHΞR𓆃👑")
...
function SMB19()
--إظهار الحدث--
gg.searchNumber("86400;24;1;5;3;5::21", gg.TYPE_DWORD)
    gg.getResults(10)
    gg.sleep(3000)
    gg.refineNumber("86400", gg.TYPE_DWORD)
    tas = gg.getResults(1000)
...
function SMB21()
--شونة دائمه--
  gg.searchNumber("50;1~99;5010::3169", gg.TYPE_DWORD)
    gg.getResults(1000)
    gg.refineNumber("1~99", gg.TYPE_DWORD)
    tas = gg.getResults(1000)
